        ...
        <div className="multiple_choice">
          ...
          <div className="true_div">
            <div className="true_question">
              <div>
                a. Computer has lack of decision-making ability.{" "}
                <strong style={{ color: "green" }}>True</strong>
              </div>
              <div>
                b. Secondary memory is the main memory of the computer.{" "}
          ...
          <div className="fill_div">
            <div className="fill_question">
              <div></div>
              <div>
                a. Most powerfull computers among digital computers are{" "}
                <small
                  style={{
              ...
              <div>
                b. Collecting the data and converting into information is called{" "}
                <small
                  style={{
                    textDecorationLine: "underline",
                    color: "green",
          ...
          <div className="long_div">
            <div className="long_question">
              ...
              <div>
                b. What is parts IPO cycle define with the help of flow chart?
              </div>
              <div>
                c. Write three parts of processing unit with the help of flow
                chart?
              </div>
