  ...
  return (
    <>
      <div className="ch1_m_ques">
        ...
        <div className="ch1_mul_question">
          <div>
            2. The contents of main memory, currently in use and likely to be needed in future is stored in which memory?
          </div>
          <div className="ch1_option">
        ...
        <div className="ch1_mul_question">
          <div>
            3. ________________keys are used for moving around in documents or web pages and editing text.
          </div>
          <div className="ch1_option">
